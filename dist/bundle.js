...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsDemo1 = __webpack_require__(/*! ./components/demo1 */ 160);
	
	var _componentsDemo12 = _interopRequireDefault(_componentsDemo1);
	
	(0, _reactDom.render)(_react2['default'].createElement(
	  _componentsDemo12['default'],
	  null,
	  'quesition'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextDemo = _react2['default'].createClass({
	    displayName: 'TextDemo',
	
	    dateToString: function dateToString(d) {
	        var str = ['hello', 'wrold'];
	        return str + [d.getFullYear(), d.getMonth() + 1, d.getDate()].join('-');
	    },
	    getThatId: function getThatId() {
	        return 'testId';
	    },
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            { className: text, id: this.getThatId() },
